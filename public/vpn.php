<h3 class="m-2 text-center">VPN HOTSPOT WIFI</h3>
<div class="set-input mt-3 p-3 d-flex justify-content-center">
    <div class="w-50">
        <div class="p-3">
            ...
            <input id="system" type="hidden" value="VPN HOTSPOT WIFI">
        </div>
        <div class="p-3 w-100">
        ...
        <div class="form-check px-5 p-3">
            <input id="detail" class="form-check-input" type="checkbox" value="VPN DCN">
            <label class="form-check-label" for="flexCheckDefault">
                VPN DCN
            </label>
        </div>
        <div class="text-center p-3">
            <button id="btn_submit" type="button" class="btn btn-primary" style="width: 120px;" onclick="submit('VPN HOTSPOT WIFI')">OK</button>
        </div>
