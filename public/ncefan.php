<h3 class="m-2 text-center">NCE FAN</h3>
<p class="text-center">NMS monitor Node Huawei Dslam/OLT</p>
    ...
    <div style="width: 80%;" class="">
        <div class="d-flex justify-content-center">
            <div class="p-3 w-50">
                ...
                <input id="system" type="hidden" value="NCE FAN">
            </div>
        </div>
        <div class="d-flex justify-content-center">
            <div class="p-3 w-50">
        ...
        <div class="text-center p-3">
            <button id="btn_submit" type="button" class="btn btn-primary" style="width: 120px;" onclick="submit('NCE FAN')">OK</button>
        </div>
