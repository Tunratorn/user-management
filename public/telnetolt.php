<h3 class="m-2 text-center">TELNET HUAWEI DSLAM OLT</h3>
<div class="set-input mt-3 p-3 d-flex justify-content-center">
    <div class="w-50">
        <div class="p-3">
            ...
            <input id="system" type="hidden" value="TELNET">
        </div>
        <div class="p-3 w-100">
        ...
        <div class="p-3 w-100">
            <select id="detail" name="area" class="w-100 selectcss">
        ...
        <div class="text-center p-3 mt-5">
            <button id="btn_submit" type="button" class="btn btn-primary" style="width: 120px;" onclick="submit('TELNET')">OK</button>
        </div>
